...
public class DepForm {
    ...
    private void initialize() {
        ...
        JPanel mainPanel = new JPanel() {
            protected void paintComponent(Graphics g) {
                ...
                Color color1 = new Color(224, 242, 255);
                Color color2 = new Color(179, 217, 255);
        ...
        scrollPane.setBorder(BorderFactory.createTitledBorder("📚 Departments List"));
    ...
    private JButton createActionButton(String text) {
        ...
        button.setBackground(new Color(0, 123, 204));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(DepForm::new);
    }
}
